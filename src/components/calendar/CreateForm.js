...
const TitleInput = ({setTitle}) => {
    return (
        <div className="mt-4">
            ...
            <input onChange={e => setTitle(e.target.value)} className="border rounded-md shadow-sm border-gray-400 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
        </div>
    )
}
